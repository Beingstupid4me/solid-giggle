...
interface ClinicalVideoSessionContentProps {
  consultationId: string;
  userRole: 'doctor' | 'medic';
  isCameraOn: boolean;
  isMicOn: boolean;
  cameraFacing: 'user' | 'environment';
  setCameraFacing: (value: 'user' | 'environment') => void;
  setIsCameraOn: (value: boolean) => void;
  setIsMicOn: (value: boolean) => void;
  onCallEnd?: () => void;
}

function ClinicalVideoSessionContent({
  consultationId,
  userRole,
  isCameraOn,
  isMicOn,
  ...
  setIsMicOn,
  onCallEnd,
}: ClinicalVideoSessionContentProps) {
  ...
  return (
    <>
      ...
      <MediaControls
        ...
        onScreenShare={userRole === 'doctor' ? undefined : undefined}
